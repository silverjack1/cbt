...
class Tes_kerjakan extends Tes_Controller
{
    ...
    function simpan_jawaban()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            $jawaban = trim($this->input->post('soal-jawaban', TRUE));
                    ...
                    if ($query_soal->soal_tipe == 1) {
                        ...
                        if ($query_jawaban->num_rows() > 0) {
                            ...
                            foreach ($query_jawaban as $jawaban) {
                                ...
                                if ($jawaban->soaljawaban_selected == 1) {
                                    $soal = $soal . '<div class="checkbox"><label><input type="checkbox" onchange="jawab()" name="soal-jawaban" value="' . $jawaban->soaljawaban_jawaban_id . '" checked> ' . $temp_jawaban . '</label></div>';
                                } else {
                                    $soal = $soal . '<div class="checkbox"><label><input type="checkbox" onchange="jawab()" name="soal-jawaban" value="' . $jawaban->soaljawaban_jawaban_id . '" > ' . $temp_jawaban . '</label></div>';
                                }
                            }
                        }
                    } else if ($query_soal->soal_tipe == 2) {
