...
<section class="content">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea class="textarea" id="tambah_soal" name="tambah_soal"
                                style="width: 100%; height: 150px; font-size: 13px; line-height: 25px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                            <p class="help-block">File gambar dapat di copy langsung atau di upload terlebih dahulu.
                                File gambar yang didukung adalah jpg dan png.</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">File Audio</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control input-sm" id="tambah-nama-audio"
                                name="tambah-nama-audio" readonly>
                        </div>
                        <div class="col-sm-4">
                            <input type="file" id="tambah-audio" name="tambah-audio">
                            <p class="help-block">File audio yang akan ditambah pada soal. ( mp3). Jika ingin menghapus
                                audio pada soal, maka Soalnya harus dihapus dahulu, setelah itu membuat soal ulang.</p>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group hide" id="form-tambah-jawaban">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control input-sm" id="tambah-kunci-jawaban-singkat"
                                name="tambah-kunci-jawaban-singkat">
                            <p class="help-block">
                                Kunci Jawaban untuk Tipe Soal Jawaban Singkat.<br />
                                Pastikan kunci jawaban hanya satu kata untuk menghindari kesalahan penulisan. Untuk
                                angka desimal gunakan tanda koma.
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" id="btn-tambah-simpan" class="btn btn-primary"><span
                                    id="judul-tambah-simpan">Simpan</span></button>
                            <button type="button" id="btn-tambah-batal"
                                class="btn btn-default"><span>Batal</span></button>
                        </div>
                    </div>
                </div>
                </form>
                                            ...
                                            <div class="row-fluid">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="hidden" id="image-topik-id"
                                                                name="image-topik-id">
    ...
    <div class="modal" id="modal-hapus-soal" data-backdrop="static" tabindex="-1" role="dialog"
