                ...
                <div class="box-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="pilih-rentang-waktu" id="pilih-rentang-waktu"
                                        class="form-control input-sm"
                                        value="<?php if(!empty($rentang_waktu)){ echo $rentang_waktu; } ?>" readonly />
                                </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="pilih-keterangan" id="pilih-keterangan"
                                    placeholder="Keterangan Peserta Tes" class="form-control input-sm" />
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-footer">
                    <button type="button" id="btn-edit-pilih" title="Pilih Hasil Tes"
                        class="btn btn-default pull-right">Pilih Semua</button>
        ...
        <div class="modal" id="modal-waktu" data-backdrop="static" tabindex="-1" role="dialog"
                        ...
                        <div class="row-fluid">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="waktu-menit" name="waktu-menit"
                                        value="10">
                                    <p class="help-block">Waktu dalam satuan MENIT</p>
                                </div>
                                <p class="">Menambah Waktu Tes melalui Penambahan "Waktu Mulai" pada user tes yang sudah
                                    dicentang sebelumnya.</p>
                                <p class="">Waktu Mulai pengerjaan Tes hasil penambahan tidak boleh melebihi waktu saat
                                    ini.</p>
                            </div>
                        </div>
                    </div>
...
function export_excel() {
    ...
    window.open("<?php echo site_url().'/'.$url; ?>/export/" + tes + "/" + group + "/" + waktu + "/" + urutkan + "/" +
        status + "/" + keterangan, "_self");
}
